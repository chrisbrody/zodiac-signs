...
function signResults() {
	...
	if (userSign == 'aries'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[0].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[0].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[0].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[0].descriptionFemale
		}		
	}
	// if TAURUS
	if (userSign == 'taurus'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[1].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[1].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[1].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[1].descriptionFemale
		}		
	}
	// if GEMINI
	if (userSign == 'gemini'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[2].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[2].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[2].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[2].descriptionFemale
		}		
	}
	// if CANCER
	if (userSign == 'cancer'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[3].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[3].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[3].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[3].descriptionFemale
		}		
	}
	// if LEO
	if (userSign == 'leo'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[4].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[4].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[4].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[4].descriptionFemale
		}		
	}
	// if VIRGO
	if (userSign == 'virgo'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[5].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[5].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[5].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[5].descriptionFemale
		}		
	}
	// if LIBRA
	if (userSign == 'libra'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[6].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[6].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[6].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[6].descriptionFemale
		}		
	}
	// if SCORPIO
	if (userSign == 'scorpio'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[7].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[7].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[7].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[7].descriptionFemale
		}		
	}
	// if SAGITTARIUS
	if (userSign == 'sagittarius'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[8].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[8].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[8].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[8].descriptionFemale
		}		
	}
	// if CAPRICORN
	if (userSign == 'capricorn'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[9].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[9].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[9].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[9].descriptionFemale
		}		
	}
	// if AQUARIUS
	if (userSign == 'Aquarius'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[10].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[10].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[10].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[10].descriptionFemale
		}		
	}
	// if PISCES
	if (userSign == 'pisces'){		
		// sign name
		document.getElementById("signName").textContent = zodiacSigns[11].signName + " - " + userGender
		// image
		document.getElementById('signImg').src = zodiacSigns[11].img
		if(userGender == 'Male') {
			// description
			document.getElementById("signInfo").textContent = zodiacSigns[11].descriptionMale		
		} else {
			document.getElementById("signInfo").textContent = zodiacSigns[11].descriptionFemale
		}		
	}
